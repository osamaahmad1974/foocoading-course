...
let pokemon = JSON.parse(fetchPokemonData()); // pokemon here is Object.
const photosKeys = Object.keys(pokemon.sprites);
const getPhotosLinks = photosKeys.map((id) => {
  if (pokemon.sprites[id] != null) {
    generateHtml(id, pokemon.sprites[id])
  }
})
